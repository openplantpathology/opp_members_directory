...
# orcid links (need to authenticate ORCID links per,
# https://orcid.org/trademark-and-id-display-guidelines#02-a)

#members_table$orcid2 <-
#  paste0(
#    "<a href = '",
#    members_table$orcid,
#    "'><i class='ai ai-orcid', style='margin-left:5px;'></i></a>"
#  )
...
members_table$twitter2 <-
  paste0(
    ...
    "'><i class='fa fa-twitter', style='color:#1da1f2;margin-left:5px;'></i></a>"
  )
...
members_table$github2 <-
  paste0(
    ...
    "'><i class='fa fa-github'; style='color:#000000;margin-left:5px;'></i></a>"
  )
